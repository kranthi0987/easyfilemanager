...
import static com.sanjay.easyfilemanager.provider.ExternalStorageProvider.ROOT_ID_SECONDARY;
...
public class SAFManager {
    ...
    public static String getRootUri(Uri uri) {
        if (isTreeUri(uri)) {
            return com.sanjay.easyfilemanager.model.DocumentsContract.getTreeDocumentId(uri);
        }
        return com.sanjay.easyfilemanager.model.DocumentsContract.getDocumentId(uri);
    }

    private static Uri buildDocumentUriMaybeUsingTree(Uri uri, String docId) {
        return com.sanjay.easyfilemanager.model.DocumentsContract.buildDocumentUriMaybeUsingTree(uri, docId);
    }

    private static boolean isTreeUri(Uri uri) {
        return com.sanjay.easyfilemanager.model.DocumentsContract.isTreeUri(uri);
    }
