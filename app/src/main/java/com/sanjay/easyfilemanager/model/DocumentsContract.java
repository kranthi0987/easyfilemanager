...
import com.sanjay.easyfilemanager.misc.OsCompat;
import com.sanjay.easyfilemanager.misc.Utils;
import com.sanjay.easyfilemanager.provider.DocumentsProvider;
import com.sanjay.easyfilemanager.provider.UsbStorageProvider;

import static com.sanjay.easyfilemanager.misc.SAFManager.DOCUMENT_AUTHORITY;
...
public final class DocumentsContract {
     ...
     */
    public static final String PROVIDER_INTERFACE = "com.sanjay.easyfilemanager.action.DOCUMENTS_PROVIDER";
     ...
     * {@link com.sanjay.easyfilemanager.model.DocumentsContract.Document#COLUMN_DOCUMENT_ID}.
     *
    ...
    /**
     * Build URI representing the target {@link com.sanjay.easyfilemanager.model.DocumentsContract.Document#COLUMN_DOCUMENT_ID} in
     * a document provider. When queried, a provider will return a single row
     * with columns defined by {@link com.sanjay.easyfilemanager.model.DocumentsContract.Document}.
     *
     ...
     * Build URI representing the children of the target directory in a document
     * provider. When queried, a provider will return zero or more rows with
     * columns defined by {@link com.sanjay.easyfilemanager.model.DocumentsContract.Document}.
     * <p>
     ...
     *            directory with MIME type of {@link com.sanjay.easyfilemanager.model.DocumentsContract.Document#MIME_TYPE_DIR}.
     * @see android.content.Intent#ACTION_OPEN_DOCUMENT_TREE
     * @see android.provider.DocumentsProvider#isChildDocument(String, String)
    ...
    /**
     * Extract the {@link com.sanjay.easyfilemanager.model.DocumentsContract.Document#COLUMN_DOCUMENT_ID} from the given URI.
     *
    ...
    /**
     * Extract the via {@link com.sanjay.easyfilemanager.model.DocumentsContract.Document#COLUMN_DOCUMENT_ID} from the given URI.
     */
