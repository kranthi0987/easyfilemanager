...
import com.sanjay.easyfilemanager.usb.UsbUtils;

import static com.sanjay.easyfilemanager.DocumentsApplication.isTelevision;
import static com.sanjay.easyfilemanager.misc.FileUtils.getTypeForName;
import static com.sanjay.easyfilemanager.misc.MimeTypes.BASIC_MIME_TYPE;
...
public class UsbStorageProvider extends DocumentsProvider {
     ...
     */
    private static final String ACTION_USB_PERMISSION = "com.sanjay.easyfilemanager.action.USB_PERMISSION";
